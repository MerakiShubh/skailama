            ...
            {!isAdding ? (
              ...
              <div className="flex w-full gap-1 px-1">
                <input
                  ...
                  className="w-4/5 text-sm border border-gray-300 rounded-md px-2 py-1 focus:outline-none focus:ring-1 focus:ring-purple-500"
                  value={newUser}
                ...
                <button
                  ...
                  disabled={isCreating}
                  className="w-1/5 bg-purple-500 text-white rounded-md text-sm font-medium hover:bg-purple-600 disabled:opacity-60 flex items-center justify-center gap-1"
                >
                  {isCreating ? (
                    <>
