      ...
      <div className="mx-auto my-auto p-3 w-full h-full md:h-3/4 md:w-8/12 bg-gray-300/20 rounded-lg">
        <div className="w-full flex justify-between items-center  md:h-1/9">
          <div className="w-full">
            <h1 className="text-black font-bold text-lg md:text-2xl">Event Management</h1>
            <p className="font-bold text-left text-xs md:text-md text-gray-400">
        ...
        <div className="w-full flex flex-col md:overflow-scroll lg:flex-row md:h-5/6 gap-8">
          <CreateEventForm />
          <Events />
        </div>
      </div>
